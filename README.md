...
small chime, in the spirit of the Supervision/Travellmate boot logo (see `docs/48`) — then the faithful SML title. It plays on power-on
and after a game over (the game restarts from scratch).
